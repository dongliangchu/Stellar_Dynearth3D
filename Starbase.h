...
FILE *inputverticesreadsortstore(struct behavior *behave,struct inputs *in,struct proxipool *pool, char *ver);
...
void inputvertexfile(struct behavior *behave,struct inputs *in,FILE **polyfile);
#if !defined(STARLIBRARY)
